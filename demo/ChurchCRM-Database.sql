...
-- Date: Sat, 27 Apr 2024 19:16:14 -0400
...
SET autocommit=0;
INSERT INTO `groupprop_master` VALUES (23,1,'c1','sdfsaf','',6,NULL,'false'),(25,1,'c1','Got a shovel?','',1,NULL,'true'),(25,2,'c2','Plot Number','',8,NULL,'true'),(25,3,'c3','Start Date','',2,NULL,'false');
/*!40000 ALTER TABLE `groupprop_master` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `groupprop_master` with 4 row(s)
--
...
SET autocommit=0;
INSERT INTO `list_lst` VALUES (1,1,1,'Member'),(1,2,2,'Regular Attender'),(1,3,3,'Guest'),(1,5,4,'Non-Attender'),(1,4,5,'Non-Attender (staff)'),(2,1,1,'Head of Household'),(2,2,2,'Spouse'),(2,3,3,'Child'),(2,4,4,'Other Relative'),(2,5,5,'Non Relative'),(3,1,1,'Ministry'),(3,2,2,'Team'),(3,3,3,'Bible Study'),(3,4,4,'Sunday School Class'),(4,1,1,'True / False'),(4,2,2,'Date'),(4,3,3,'Text Field (50 char)'),(4,4,4,'Text Field (100 char)'),(4,5,5,'Text Field (Long)'),(4,6,6,'Year'),(4,7,7,'Season'),(4,8,8,'Number'),(4,9,9,'Person from Group'),(4,10,10,'Money'),(4,11,11,'Phone Number'),(4,12,12,'Custom Drop-Down List'),(5,1,1,'bAll'),(5,2,2,'bAdmin'),(5,3,3,'bAddRecords'),(5,4,4,'bEditRecords'),(5,5,5,'bDeleteRecords'),(5,7,7,'bManageGroups'),(5,8,8,'bFinance'),(5,9,9,'bNotes'),(5,11,11,'bCanvasser'),(10,1,1,'Teacher'),(10,2,2,'Student'),(11,1,1,'Member'),(12,1,1,'Teacher'),(12,2,2,'Student'),(13,1,1,'Teacher'),(13,2,2,'Student'),(14,1,1,'Teacher'),(14,2,2,'Student'),(15,1,1,'Teacher'),(15,2,2,'Student'),(16,1,1,'Teacher'),(16,2,2,'Student'),(17,1,1,'Teacher'),(17,2,2,'Student'),(18,1,1,'Teacher'),(18,2,2,'Student'),(19,1,1,'Member'),(20,1,1,'Member'),(21,1,1,'Member'),(3,5,5,'Scouts'),(22,1,1,'Member'),(23,1,1,'Member'),(24,1,1,'Default Option'),(24,2,2,'My Custom Item 1'),(24,3,3,'My Custom Item 2'),(25,1,1,'Default Option'),(26,1,1,'Member'),(27,1,1,'Member'),(28,1,1,'Member'),(29,1,1,'Member'),(30,1,1,'Member'),(31,1,1,'Member'),(32,1,1,'Member'),(33,1,1,'Member'),(34,1,1,'Member'),(35,1,1,'Member'),(36,1,1,'Member'),(37,1,2,'Member'),(37,2,1,'sdfsdf'),(38,1,1,'Member');
/*!40000 ALTER TABLE `list_lst` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `list_lst` with 76 row(s)
--
...
CREATE TABLE `note_nte` (
  ...
  PRIMARY KEY (`nte_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=636 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET autocommit=0;
INSERT INTO `person2group2role_p2g2r` VALUES (2,9,1),(2,11,1),(4,1,1),(5,1,2),(7,6,1),(8,1,2),(9,1,2),(10,2,2),(11,3,2),(12,5,2),(13,2,2),(16,5,2),(21,6,2),(22,4,2),(24,4,2),(25,5,2),(26,7,1),(26,11,1),(30,3,2),(60,7,1),(61,25,1),(63,1,1),(63,8,1),(67,2,1),(79,5,1),(79,9,1),(80,2,2),(80,8,1),(82,2,2),(83,9,1),(93,6,1),(95,8,1),(96,5,2),(100,4,1),(222,23,2),(223,23,2),(224,23,2),(225,23,2),(226,23,2),(227,23,2);
/*!40000 ALTER TABLE `person2group2role_p2g2r` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `person2group2role_p2g2r` with 40 row(s)
--
...
-- Dump completed on: Sat, 27 Apr 2024 19:16:15 -0400
